  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-md bg-white/90 dark:bg-stone-900 shadow-soft backdrop-blur-xl p-6 sm:p-10 rounded-[32px] sm:rounded-[48px] border border-white dark:border-stone-800 relative z-10"
      >
        <div className="flex flex-col items-center mb-6 sm:mb-10">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-accent rounded-3xl flex items-center justify-center shadow-lg shadow-accent/20 dark:shadow-none mb-4 sm:mb-6">
            <Leaf className="text-white w-8 h-8 sm:w-10 sm:h-10" />
          </div>
          <h1 className="text-3xl sm:text-4xl font-black text-text-primary dark:text-white tracking-tighter font-display uppercase italic">Bio<span className="text-accent">Scan.</span></h1>
        ...
        <div className="flex bg-bg-start/50 dark:bg-stone-800 p-1.5 rounded-full mb-6 sm:mb-10 border border-white/50">
          <button 
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-5">
          ...
          {error && (
            <motion.div 
              ...
              className="flex items-center gap-3 p-4 sm:p-5 bg-rose-500/10 text-rose-600 dark:text-rose-400 rounded-3xl text-xs font-bold border border-rose-500/20"
            >
              <AlertCircle size={18} />
              {error}
            </motion.div>
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full py-4 sm:py-5 bg-accent text-white rounded-full font-black text-sm uppercase tracking-[0.2em] shadow-lg shadow-accent/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-70 mt-4"
          >
            {loading ? (
